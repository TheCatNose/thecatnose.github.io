...
class VideoDb {
	...
	static _initCollections() {
		...
		vid = new Video('Best of Modarchive 2007', 'boma-2007', 'T5LXFlGJEQs')
		col.add(vid)
		vid.add('00:00:00', 'virt - good morning, dracula')
		vid.add('00:02:28', 'coma - skogens djur 011')
		vid.add('00:03:41', '4mat - anarchy menu 4')
		vid.add('00:05:15', 'dalezy - intro numma (70)')
		vid.add('00:05:48', "skuter - flimbo's quest")
		vid.add('00:07:06', 'jellydog and loonie - ultrajakob')
		vid.add('00:08:30', 'pink - summertime-part_2')
		vid.add('00:12:45', 'Edzes, Mick Rippon, zabutom - 64 the magic number')
		vid.add('00:15:05', 'Darkman007 - Invite for CC07')
		vid.add('00:18:00', 'makko - nyponsoppa')
		vid.add('00:20:18', 'cerror - Joey le taxi')
		vid.add('00:22:03', 'JDruid - 2 minutes left')
		vid.add('00:24:01', 'Dr. J - d-3000')
		vid.add('00:25:11', 'emax - flippy introtune')
		vid.add('00:27:16', 'zabutom - blank mind')
		vid.add('00:29:32', "radix - linda's world")
		vid.add('00:30:52', 'radix - asm95 icecream girl')
		vid.add('00:31:54', 'radix - hammastahna')
		vid.add('00:32:42', 'virt - lick the alphabet')
		vid.add('00:35:01', 'radix - weather girl')
		vid.add('00:36:26', 'Traven - Orange Juice Theme')
		vid.add('00:41:31', 'radix - happy sundays')
		vid.add('00:43:52', 'dubmood and zabutom - A tribute to Kootie')
		vid.add('00:47:24', 'beek - beehive!')
		vid.add('00:48:35', 'radix - tpolmboy')
		vid.add('00:49:44', 'Doh - Thermostat 7')
		vid.add('00:52:12', 'zabutom, nagz - cloudcones')
		vid.add('00:54:04', 'd.s.x. design - intro.dsx.4')
		vid.add('00:55:07', 'vincenzo - Reloaded')
		vid.add('00:57:11', 'tempest - acidjazzed evening')
		vid.add('01:00:24', 'chavez and goto80 - Minäkö?')
		vid.add('01:02:21', 'radix - my little ponies')
		vid.add('01:04:37', 'DRAX - NOISY PILLARS 2001')
		vid.add('01:06:47', '4mat - Eternity')
		vid.add('01:09:43', 'radix - rainy summerdays')
		vid.add('01:12:21', 'radix - ma petite fleur')
		vid.add('01:14:00', 'zabutom - lost days')
		...
		vid = new Video('Best of Modarchive 2005', 'boma-2005', 'Z_97j2fdO-4')
		col.add(vid)
		vid.add('00:00', 'Ceekayed - Layers')
		vid.add('02:42', 'emax - flippy introtune')
		vid.add('04:46', 'pricky - Azadeh')
		vid.add('05:58', 'maniac - brillsmurf')
		vid.add('08:02', 'kenet - netro intro')
		vid.add('10:07', 'maniac - flintastek')
		vid.add('11:00', 'nula - sparapaaczci')
		vid.add('12:55', 'oxide - musik.04')
		vid.add('13:58', 'edzes - fish and chips')
		vid.add('16:13', 'JosSs - HappyNext')
		vid.add('18:12', 'radix - happy sundays')
		vid.add('19:52', 'zalza - kärleksmums')
		vid.add('23:06', 'ogge and svenzzon - Past the orion')
		vid.add('24:27', 'seablue - aurora dawn')
		vid.add('27:01', 'loonie - outruned')
		vid.add('28:48', 'bzl - doctrine cracktro')
		vid.add('30:20', 'edzes - stop the watch!')
		vid.add('31:25', 'reed - jazzberry juice')
		vid.add('34:51', 'rez and kenet - unreeeal superhero 3')
		vid.add('36:49', 'DRAX - TINTIN ON THE MOON (remake)')
		vid.add('37:35', 'lithis and malmen - ginseng')
		vid.add('40:10', 'loonie - motornäsklipparen')
		vid.add('41:32', 'DRAX - CAPE HORN')
		vid.add('45:35', 'cerror - pigs go oink')
		vid.add('46:32', 'loonie - liten')
		vid.add('48:00', 'zalza - karatemuffins')
		
		vid = new Video('Best of Modarchive 2004', 'boma-2004', 'wBnu7DkXzfk')
		col.add(vid)
		vid.add('00:00:00', 'oxbow - artcore-hidden')
		vid.add('00:01:09', 'virt - bzam')
		vid.add('00:04:18', 'joule - disco vering')
		vid.add('00:06:26', 'loonie - gary & denise')
		vid.add('00:07:42', 'joule - milkshake41')
		vid.add('00:09:34', 'radix & loonie - kookoo')
		vid.add('00:12:47', '4mat - anarchymenu4')
		vid.add('00:14:15', 'curt cool - necrophobia')
		vid.add('00:17:01', 'mrdeath - omega illusion')
		vid.add('00:19:16', 'joule - racing kirby')
		vid.add('00:20:25', 'coma - skogens djur 028')
		vid.add('00:21:40', 'wire - Wings of Death')
		vid.add('00:25:19', 'auricom - fångad aven korvring')
		vid.add('00:26:55', "coma - rick's theme")
		vid.add('00:28:22', 'curt cool - bittersweet')
		vid.add('00:30:32', 'dualtrax - crome vs. pikachu')
		vid.add('00:32:06', 'zalza - pr0ndisk outro')
		vid.add('00:33:22', 'm.c.mp - happy new year 1993')
		vid.add('00:35:12', 'emax - flippy introtune')
		vid.add('00:37:17', 'dualtrax - shining like a star part#2')
		vid.add('00:39:10', 'DRAX - Christmas Memories')
		vid.add('00:42:00', 'mrdeath - Ganja Oracle')
		vid.add('00:44:01', 'Jeroen Tel - Hypnosis 3D Demo')
		vid.add('00:47:28', 'tempest - mr.solid')
		vid.add('00:50:50', 'edzes & dot - my valentine')
		vid.add('00:52:47', 'KeyG - a car')
		vid.add('00:53:36', 'JosSs - Broken Brain')
		vid.add('00:56:14', 'zabutom & dubmood - ST-Style')
		vid.add('00:58:10', 'tempest - zen-bowling')
		vid.add('00:59:43', 'dualtrax and bzl - Ballade of the storm')
		vid.add('01:01:22', 'dubmood - Afterburner')
		vid.add('01:05:01', 'dubmood - Cydonian Sky')
		vid.add('01:07:56', 'DRAX - QUICKSTEP')
		vid.add('01:10:58', 'DRAX - ZOO-CONNECTIONS')
		vid.add('01:13:46', 'lizardking - Trans atlantic')
		vid.add('01:16:07', 'dubmood - Toffelskater')
		vid.add('01:19:21', 'dubmood - KRUT Fotboll')
		vid.add('01:23:06', 'zalza - fly bird "funktro"')
		vid.add('01:25:31', 'tempest - blackjack')
		vid.add('01:30:24', 'skuter - in your arms')
		vid.add('01:31:27', 'radix - hammastahna')
		vid.add('01:32:20', 'gandbox - master chef')
		vid.add('01:34:16', 'edzes & auricom - Related memories')
		vid.add('01:37:10', 'pink - rob mat reyn pink')
		vid.add('01:41:10', 'dubmood - 3D Galax')
		vid.add('01:44:52', 'DRAX - RUBICON 99')
		vid.add('01:48:47', 'dubmood - Paradox #3')
		vid.add('01:50:26', "dot & edzes - stimpy's camelrace")
		vid.add('01:52:24', 'dubmood - Team Haze Chiptune')
		vid.add('01:53:43', 'pink - classic tunes')
		vid.add('01:55:13', 'lesnik - one hot dog')
		vid.add('01:57:23', 'filippetto - stormy & clever')
		vid.add('01:59:25', 'zalza - alf2')
		vid.add('01:59:55', 'tempest - free fjortis facials')
		vid.add('02:01:56', 'edzes and loonie - ulf’s vibrator')
		vid.add('02:04:16', 'virt - option (gradius 2)')
		vid.add('02:07:08', 'dubmood and zabutom - oh ym2149 sexy thing!')
		vid.add('02:09:30', 'loonie - back2k')
		vid.add('02:10:57', 'dubmood and nadom - prask')
		vid.add('02:14:10', 'DRAX - No Expectations')
		vid.add('02:16:13', 'zabutom & dubmood - lite lösa tankar åså')
		vid.add('02:19:21', 'dubmood - Botkyrka Sidekickers')
		vid.add('02:21:14', 'captain - beyond music')
		vid.add('02:25:42', 'zabutom & dubmood - Songs from the Cell')
		...
		vid.add('02:26', 'cerror - crack_01')

		vid = new Video('Best of Modarchive July 2025', 'boma-2025-07', '55WEduvZHJY')
		col.add(vid)
		vid.add('00:00', 'JosSs - loorah!')
		vid.add('02:41', 'Firage - Spicy Italian')
		vid.add('06:35', 'JosSs - audrey')
		vid.add('09:38', 'bzl - zeroplex')
